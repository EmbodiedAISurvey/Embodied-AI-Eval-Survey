...
14. Open6DOR: Benchmarking open-instruction 6-DoF object rearrangement and a VLM-based approach. Yufei Ding et al. 2024 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2024. [[paper](https://ieeexplore.ieee.org/abstract/document/10802733)]
...
4. Embodiedbench: Comprehensive benchmarking multi-modal large language models for vision-driven embodied agents. Rui Yang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2502.09560)][[projectpage](https://embodiedbench.github.io/)][[data](https://huggingface.co/EmbodiedBench)][[GitHub](https://github.com/EmbodiedBench/EmbodiedBench)]
5. Graspnet-1billion: A large-scale benchmark for general object grasping. Hao-Shu Fang et al. CVPR 2020. [[paper](https://openaccess.thecvf.com/content_CVPR_2020/html/Fang_GraspNet-1Billion_A_Large-Scale_Benchmark_for_General_Object_Grasping_CVPR_2020_paper.html)][[projectpage](https://graspnet.net/)]
6. Alfworld: Aligning text and embodied environments for interactive learning. Mohit Shridhar et al. arXiv 2020. [[paper](https://arxiv.org/abs/2010.03768)][[projectpage](http://alfworld.github.io/)]
7. Lohoravens: A long-horizon language-conditioned benchmark for robotic tabletop manipulation. Shengqiang Zhang et al. arXiv 2023. [[paper](https://arxiv.org/abs/2310.12020)][[projectpage](https://cisnlp.github.io/lohoravens-webpage/)]
8. Visual room rearrangement. Luca Weihs et al. CVPR 2021. [[paper](https://openaccess.thecvf.com/content/CVPR2021/html/Weihs_Visual_Room_Rearrangement_CVPR_2021_paper.html)][[projectpage](https://ai2thor.allenai.org/rearrangement/)]
9. Objectnav revisited: On evaluation of embodied agents navigating to objects. Dhruv Batra et al. arXiv 2020. [[paper](https://arxiv.org/abs/2006.13171)]
10. MoMa-Kitchen: A 100K+ Benchmark for Affordance-Grounded Last-Mile Navigation in Mobile Manipulation. Pingrui Zhang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2503.11081)][[projectpage](https://momakitchen.github.io/)]
11. On evaluation of embodied navigation agents. Peter Anderson et al. arXiv 2018. [[paper](https://arxiv.org/abs/1807.06757)]
12. Hm3d-ovon: A dataset and benchmark for open-vocabulary object goal navigation. Naoki Yokoyama et al. 2024 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2024. [[paper](https://ieeexplore.ieee.org/abstract/document/10802709)][[projectpage](https://naoki.io/portfolio/ovon)]
13. SimWorld-Robotics: Synthesizing Photorealistic and Dynamic Urban Environments for Multimodal Robot Navigation and Collaboration. Yan Zhuang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2512.10046)][[projectpage](https://scai.cs.jhu.edu/projects/SimWorldRobotics/)]
14. Uav-on: A benchmark for open-world object goal navigation with aerial agents. Jianqiang Xiao et al. Proceedings of the 33rd ACM International Conference on Multimedia 2025. [[paper](https://dl.acm.org/doi/abs/10.1145/3746027.3758251)][[code&benchmark](https://github.com/Kyaren/UAV_ON)]
15. Goat-bench: A benchmark for multi-modal lifelong navigation. Mukul Khanna et al. CVPR 2024. [[paper](https://openaccess.thecvf.com/content/CVPR2024/html/Khanna_GOAT-Bench_A_Benchmark_for_Multi-Modal_Lifelong_Navigation_CVPR_2024_paper.html)][[projectpage](https://mukulkhanna.github.io/goat-bench/)]
16. TongSIM: A General Platform for Simulating Intelligent Machines. Sun et al. arXiv 2025. [[paper](https://arxiv.org/abs/2512.20206)][[Github](https://github.com/bigai-ai/tongsim)]
17. RoboCasa365: A Large-Scale Simulation Framework for Training and Benchmarking Generalist Robots. Nasiriany et al. ICLR 2026. [[paper](https://arxiv.org/abs/2603.04356)][[Github](https://robocasa.ai/)]
18. BEDI: a comprehensive benchmark for evaluating embodied agents on UAVs. Guo et al. ISPRS 2026. [[paper](https://www.sciencedirect.com/science/article/abs/pii/S0924271626000134)][[Github](https://github.com/lostwolves/BEDI)]
19. User-Centric Object Navigation: A Benchmark with Integrated User Habits for Personalized Embodied Object Search. Wang et al. ICRA 2026. [[paper](https://arxiv.org/abs/2602.06459)][[Github](https://github.com/whcpumpkin/User-Centric-Object-Navigation)]
20. ScenePilot-Bench: A Large-Scale Dataset and Benchmark for Evaluation of Vision-Language Models in Autonomous Driving. Wang et al. arXiv 2026. [[paper](https://arxiv.org/abs/2601.19582)]
...
15. PersONAL: Towards a Comprehensive Benchmark for Personalized Embodied Agents. Filippo Ziliotto et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.19843)][[data](https://github.com/ZiliottoFilippoDev/PersONAL)]
16. Dialfred: Dialogue-enabled agents for embodied instruction following. Xiaofeng Gao et al. IEEE Robotics and Automation Letters 2022. [[paper](https://ieeexplore.ieee.org/abstract/document/9837390)][[code&data](http://github.com/xfgao/DialFRED)]
17. Towards autonomous micromobility through scalable urban simulation. Wayne Wu et al. CVPR 2025. [[paper](https://arxiv.org/abs/2505.00690)][[projectpage](https://metadriverse.github.io/urbansim/)]
...
[[code](https://github.com/metadriverse/MetaVQA)]
2. The Human Robot Social Interaction (HSRI) Dataset: Benchmarking Foundational Models' Social Reasoning. Dong Won Lee et al. arXiv 2025. [[paper](https://arxiv.org/abs/2504.13898)]
3. Muma-tom: Multi-modal multi-agent theory of mind. Haojun Shi et al. Proceedings of the AAAI Conference on Artificial Intelligence 2025. [[paper](https://arxiv.org/abs/2408.12574)]
[[projectpage](https://scai.cs.jhu.edu/projects/MuMA-ToM/)]
[[code](https://github.com/SCAI-JHU/MuMA-ToM)]
[[data](https://huggingface.co/datasets/SCAI-JHU/MUMA-TOM-BENCHMARK)]
4. A Framework for Benchmarking and Aligning Task-Planning Safety in LLM-Based Embodied Agents. Yuting Huang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2504.14650)]
5. Safeagentbench: A benchmark for safe task planning of embodied llm agents. Sheng Yin et al. arXiv 2024. [[paper](https://arxiv.org/abs/2412.13178)]
[[code](https://github.com/shengyin1224/SafeAgentBench)]
[[data](https://huggingface.co/datasets/safeagentbench/SafeAgentBench)]
6. SENTINEL: A Multi-Level Formal Framework for Safety Evaluation of LLM-based Embodied Agents. Simon Sinong Zhan et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.12985)]
7. Why do mllms struggle with spatial understanding? a systematic analysis from data to architecture. Wanyue Zhang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.02359)]
[[code](https://github.com/WanyueZhang-ai/spatial-understanding)]
[[data](https://huggingface.co/datasets/WanyueZhang/MulSeT)]
8. NeuronsGym: A Hybrid Framework and Benchmark for Robot Navigation With Sim2Real Policy Learning. Haoran Li et al. IEEE Transactions on Emerging Topics in Computational Intelligence 2024. [[paper](https://arxiv.org/abs/2302.03385)][[projectpage](https://ieee-cog.org/2022/cog_sim2real/index.html)]
[[code](https://github.com/DRL-CASIA/NeuronsGym)]
9. Robocas: A benchmark for robotic manipulation in complex object arrangement scenarios. Liming Zheng et al. arXiv 2024. [[paper](https://arxiv.org/abs/2407.06951)][[data](https://huggingface.co/datasets/zlm898/RoboCAS-v0)]
[[GitHub](https://github.com/notFoundThisPerson/RoboCAS-v0)]
10. Can AI Perceive Physical Danger and Intervene?. Abhishek Jindal et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.21651)][[projectpage](https://asimov-benchmark.github.io/v2/)]
[[data](https://colab.research.google.com/drive/1ANSRfztNCHqCQNHl9sDtmPMAXD4l2UiW?usp=sharing)]
11. Earbench: Towards evaluating physical risk awareness for task planning of foundation model-based embodied ai agents. Zihao Zhu et al. arXiv 2024. [[paper](https://arxiv.org/abs/2408.04449)]
[[GitHub](https://github.com/zihao-ai/EARBench)]
12. HomeSafeBench: A Benchmark for Embodied Vision-Language Models in Free-Exploration Home Safety Inspection. Siyuan Gao et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.23690)]
13. AGENTSAFE: Benchmarking the Safety of Embodied Agents on Hazardous Instructions. Aishan Liu et al. ICML 2026. [[paper](https://arxiv.org/abs/2506.14697)]
14. IS-Bench: Evaluating Interactive Safety of VLM-Driven Embodied Agents in Daily Household Tasks. Xiaoya Lu et al. arXiv 2025. [[paper](https://arxiv.org/abs/2506.16402)]
[[GitHub](https://github.com/AI45Lab/IS-Bench)]
15. Exploring the adversarial vulnerabilities of vision-language-action models in robotics. Taowen Wang et al. ICCV 2025. [[paper](https://arxiv.org/abs/2411.13587)][[projectpage](https://vlaattacker.github.io/)]
[[code](https://github.com/William-wAng618/roboticAttack)]
16. ANNIE: Be careful of your robots. Yiyang Huang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.03383)]
[[GitHub](https://github.com/RLC-Lab/Annie)]
17. Manipulation Facing Threats: Evaluating Physical Vulnerabilities in End-to-End Vision Language Action Models. Hao Cheng et al. arXiv 2024. [[paper](https://arxiv.org/abs/2409.13174)][[projectpage](https://chaducheng.github.io/Manipulate-Facing-Threats/)]
[[video](https://www.youtube.com/watch?v=Zd7a2e9cEMY)]
18. Goal-oriented Backdoor Attack against Vision-Language-Action Models via Physical Objects. Zirun Zhou et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.09269)][[projectpage](https://goba-attack.github.io/)]
[[code](https://github.com/trustmlyoungscientist/GoBA_attack)]
[[data](https://huggingface.co/datasets/ZZR42/BadLIBERO)]
19. Advancing Embodied Agent Security: From Safety Benchmarks to Input Moderation. Ning Wang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2504.15699)]
[[GitHub](https://github.com/ZihanYan-CQU/EAsafetyBench)]
20. Injecagent: Benchmarking indirect prompt injections in tool-integrated large language model agents. Qiusi Zhan et al. arXiv 2024. [[paper](https://arxiv.org/abs/2403.02691)]
[[GitHub](https://github.com/uiuc-kang-lab/InjecAgent)]
21. The Shawshank Redemption of Embodied AI: Understanding and Benchmarking Indirect Environmental Jailbreaks. Chunyang Li et al. arXiv 2025. [[paper](https://arxiv.org/abs/2511.16347)]
22. Evaluating LLM Safety Across Child Development Stages: A Simulated Agent Approach. Abhejay Murali et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.05484)]
23. Measuring Physical-World Privacy Awareness of Large Language Models: An Evaluation Benchmark. Xinjie Shen et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.02356)]
[[GitHub](https://github.com/Graph-COM/EAPrivacy)]
24. SafeMind: Benchmarking and Mitigating Safety Risks in Embodied LLM Agents. Ruolin Chen et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.25885)]
25. HASARD: A Benchmark for Vision-Based Safe Reinforcement Learning in Embodied Agents. Tristan Tomilin et al. arXiv 2025. [[paper](https://arxiv.org/abs/2503.08241)][[projectpage](https://sites.google.com/view/hasard-bench/)]
[[GitHub](https://github.com/TTomilin/HASARD)]
...
2. PoseBench: Benchmarking the robustness of pose estimation models under corruptions. Sihan Ma et al. arXiv 2024. [[paper](https://arxiv.org/abs/2406.14367)][[projectpage](https://xymsh.github.io/PoseBench/)]
3. Robust slam systems: Are we there yet?. Mihai Bujanca et al. 2021 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) 2021. [[paper](https://arxiv.org/abs/2109.13160)][[projectpage](https://robustslam.github.io/evaluation/)]
4. Challenges of Indoor SLAM: A multi-modal multi-floor dataset for SLAM evaluation. Pushyami Kaveti et al. 2023 IEEE 19th International Conference on Automation Science and Engineering (CASE) 2023. [[paper](https://arxiv.org/abs/2306.08522)]
[[GitHub](https://github.com/neufieldrobotics/NUFR-M3F)]
5. Customizable perturbation synthesis for robust slam benchmarking. Xiaohao Xu et al. arXiv 2024. [[paper](https://arxiv.org/abs/2402.08125)]
[[GitHub](https://github.com/Xiaohao-Xu/SLAM-under-Perturbation/)]
6. Understanding why slam algorithms fail in modern indoor environments. Linus Nwankwo et al. International Conference on Robotics in Alpe-Adria Danube Region 2023. [[paper](https://arxiv.org/abs/2305.05313)][[projectpage](https://cps.unileoben.ac.at/)]
7. Autonomous navigation through gmapping-based slam: A comprehensive evaluation. Sakthiprasad Kuttankulangara Manoharan et al. 2024 7th International Conference on Circuit Power and Computing Technologies (ICCPCT) 2024. [[paper](https://ieeexplore.ieee.org/document/10673228)]
8. Mapeval: towards unified, robust and efficient slam map evaluation framework. Xiangcheng Hu et al. IEEE Robotics and Automation Letters 2025. [[paper](https://arxiv.org/abs/2411.17928)]
9. Design and evaluation of a generic visual slam framework for multi camera systems. Pushyami Kaveti et al. IEEE Robotics and Automation Letters 2023. [[paper](https://arxiv.org/abs/2210.07315)]
10. A Review of Simultaneous Localization and Mapping for the Robotic-Based Nondestructive Evaluation of Infrastructures. Ali Ghadimzadeh Alamdari et al. Sensors 2025. [[paper](https://www.mdpi.com/1424-8220/25/3/712)]
11. How challenging is a challenge? cems: a challenge evaluation module for slam visual perception. Xuhui Zhao et al. Journal of Intelligent \& Robotic Systems 2024. [[paper](https://link.springer.com/article/10.1007/s10846-024-02077-4)]
...
[[GitHub](https://github.com/aiben-ch/EmbodiedIQA)]
13. The colosseum: A benchmark for evaluating generalization for robotic manipulation. Wilbert Pumacay et al. arXiv 2024. [[paper](https://arxiv.org/abs/2402.08191)][[projectpage](https://robot-colosseum.github.io/)]
[[code](https://github.com/robot-colosseum/robot-colosseum)]
[[data](https://huggingface.co/datasets/colosseum/colosseum-challenge)]
...
15. NoisyEQA: benchmarking embodied question answering with imperfect queries from non-expert users. Tao Wu Venue 2025. [[paper](https://arxiv.org/abs/2412.10726)]
16. Mini-behavior: A procedurally generated benchmark for long-horizon decision-making in embodied ai. Emily Jin et al. arXiv 2023. [[paper](https://arxiv.org/abs/2310.01824)]
[[GitHub](https://github.com/StanfordVL/mini_behavior)]
17. Behavior: Benchmark for everyday household activities in virtual, interactive, and ecological environments. Sanjana Srivastava et al. Conference on robot learning 2022. [[paper](https://arxiv.org/abs/2108.03332)][[projectpage](https://behavior.stanford.edu/)]
18. Behavior-1k: A human-centered, embodied ai benchmark with 1,000 everyday activities and realistic simulation. Chengshu Li et al. arXiv 2024. [[paper](https://arxiv.org/abs/2403.09227)][[projectpage](https://behavior.stanford.edu/)]
...
20. NoTVLA: Narrowing of Dense Action Trajectories for Generalizable Robot Manipulation. Zheng Huang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.03895)]
21. Calvin: A benchmark for language-conditioned policy learning for long-horizon robot manipulation tasks. Oier Mees et al. IEEE Robotics and Automation Letters 2022. [[paper](https://arxiv.org/abs/2112.03227)][[projectpage](http://calvin.cs.uni-freiburg.de/)]
22. Egoplan-bench: Benchmarking multimodal large language models for human-level planning. Yi Chen et al. arXiv 2023. [[paper](https://arxiv.org/abs/2312.06722)]
[[GitHub](https://github.com/ChenYi99/EgoPlan)]
23. Bear: Benchmarking and enhancing multimodal language models for atomic embodied capabilities. Yu Qi et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.08759)][[projectpage](https://bear-official66.github.io/)]
[[code](https://github.com/yqi19/BEAR-official)]
[[data](https://huggingface.co/papers/2510.08759)]
24. VLATest: Testing and Evaluating Vision-Language-Action Models for Robotic Manipulation. Zhijie Wang et al. Proceedings of the ACM on Software Engineering 2025. [[paper](https://arxiv.org/abs/2409.12894)]
25. NEBULA: Do We Evaluate Vision-Language-Action Agents Correctly?. Jierui Peng et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.16263)][[projectpage](https://vulab-ai.github.io/NEBULA-Alpha/)]
[[GitHub](https://github.com/JerryPeng0201/NEBULA)]
26. Eva-VLA: Evaluating Vision-Language-Action Models' Robustness Under Real-World Physical Variations. Hanqing Liu et al. arXiv 2025. [[paper](https://arxiv.org/abs/2509.18953)]
27. Partnr: A benchmark for planning and reasoning in embodied multi-agent tasks. Matthew Chang et al. arXiv 2024. [[paper](https://arxiv.org/abs/2411.00081)][[projectpage](https://aihabitat.org/partnr/)]
[[code](https://github.com/facebookresearch/partnr-planner)]
28. Multibench: Multiscale benchmarks for multimodal representation learning. Paul Pu Liang et al. NeurIPS 2021. [[paper](https://arxiv.org/abs/2107.07502)][[projectpage](https://cmu-multicomp-lab.github.io/multibench/)]
[[GitHub](https://github.com/pliang279/MultiBench)]
29. Libero-plus: In-depth robustness analysis of vision-language-action models. Senyu Fei et al. arXiv 2025. [[paper](https://arxiv.org/abs/2510.13626)][[projectpage](https://sylvestf.github.io/LIBERO-plus/)]
...
[[data](https://huggingface.co/datasets/rjgpinel/GEMBench)]
2. MazeEval: A Benchmark for Testing Sequential Decision-Making in Language Models. Hafsteinn Einarsson arXiv 2025. [[paper](https://arxiv.org/abs/2507.20395)][[projectpage](https://haffi112.github.io/maze-navigation-game/)]
3. Et-plan-bench: Embodied task-level planning benchmark towards spatial-temporal cognition with foundation models. Lingfeng Zhang et al. arXiv 2024. [[paper](https://arxiv.org/abs/2410.14682)]
4. Surprise3d: A dataset for spatial understanding and reasoning in complex 3d scenes. Jiaxin Huang et al. arXiv 2025. [[paper](https://arxiv.org/abs/2507.07781)]
[[GitHub](https://github.com/liziwennba/SURPRISE3D)]
...
6. Libero: Benchmarking knowledge transfer for lifelong robot learning. Bo Liu et al. NeurIPS 2023. [[paper](https://arxiv.org/abs/2306.03310)][[projectpage](https://libero-project.github.io/intro.html)]
7. DialNav: Multi-turn Dialog Navigation with a Remote Guide. Leekyeung Han et al. ICCV 2025. [[paper](https://arxiv.org/abs/2509.12894)][[projectpage](https://happilee12.github.io/DialNav/)]
[[code](https://github.com/happilee12/DialNav)]
[[data](https://drive.google.com/drive/folders/1Pp_HOUDIo-uKQph18w-zqUMHcDJ6Gmg0?pli=1)]
...
10. Mind and motion aligned: a joint evaluation ISAACSIM benchmark for task planning and low-level policies in mobile manipulation. Nikita Kachaev et al. arXiv 2025. [[paper](https://arxiv.org/abs/2508.15663)][[projectpage](https://dsworks.ru/group/ai-journey-contest-2024)]
11. Maniskill-hab: A benchmark for low-level manipulation in home rearrangement tasks. Arth Shukla et al. arXiv 2024. [[paper](https://arxiv.org/abs/2412.13211)][[projectpage](https://arth-shukla.github.io/mshab/)]
[[code](https://github.com/arth-shukla/mshab)]
[[data](https://arth-shukla.github.io/mshab/#dataset-section)]
...
13. Rethinking the embodied gap in vision-and-language navigation: A holistic study of physical and visual disparities. Liuyi Wang et al. ICCV 2025. [[paper](https://arxiv.org/abs/2507.13019)][[projectpage](https://crystalsixone.github.io/vln_pe.github.io/)]
[[code](https://github.com/InternRobotics/InternNav/tree/main)]
14. Benchmarking vision, language, \& action models on robotic learning tasks. Pranav Guruprasad et al. arXiv 2024. [[paper](https://arxiv.org/abs/2411.05821)]
15. EnvTrace: Simulation-Based Semantic Evaluation of LLM Code via Execution Trace Alignment--Demonstrated at Synchrotron Beamlines. Noah van der Vleuten et al. arXiv 2025. [[paper](https://arxiv.org/abs/2511.09964)]
[[GitHub](https://github.com/CFN-softbio/EnvTrace)]
16. ReALFRED: An Embodied Instruction Following Benchmark in Photo-Realistic Environments. Taewoong Kim et al. ECCV 2024. [[paper](https://arxiv.org/abs/2407.18550)][[projectpage](https://twoongg.github.io/projects/realfred/)]
[[code](https://github.com/snumprlab/realfred)]
17. Robothor: An open simulation-to-real embodied ai platform. Matt Deitke et al. CVPR 2020. [[paper](https://arxiv.org/abs/2004.06799)][[projectpage](https://ai2thor.allenai.org/robothor)]
18. EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device. Gunjan Chhablani et al. ICCV 2025. [[paper](https://arxiv.org/abs/2509.17430)][[projectpage](https://gchhablani.github.io/embodied-splat/)]
[[code](https://github.com/gchhablani/embodied-splat-v1)]
[[data](https://huggingface.co/datasets/gchhablani/embodied-splat)]
19. Maniskill: Generalizable manipulation skill benchmark with large-scale demonstrations. Tongzhou Mu et al. arXiv 2021. [[paper](https://arxiv.org/abs/2107.14483)][[GitHub](https://github.com/haosulab/ManiSkill)]
20. M3Bench: Benchmarking Whole-Body Motion Generation for Mobile Manipulation in 3D Scenes. Zeyu Zhang et al. IEEE Robotics and Automation Letters 2025. [[paper](https://arxiv.org/abs/2410.06678)][[projectpage](https://zeyuzhang.com/papers/m3bench)]
[[code](https://github.com/TooSchoolForCool/M3Bench)]
[[data](https://huggingface.co/datasets/M3Bench/M3Bench)]
21. AnyBody: A Benchmark Suite for Cross-Embodiment Manipulation. Meenal Parakh et al. arXiv 2025. [[paper](https://arxiv.org/abs/2505.14986)][[projectpage](https://princeton-vl.github.io/anybody/)]
[[GitHub](https://github.com/meenalparakh/anybody)]
22. Avalon: A benchmark for rl generalization using procedurally generated worlds. Joshua Albrecht et al. NeurIPS 2022. [[paper](https://arxiv.org/abs/2210.13417)]
23. Meta-world: A benchmark and evaluation for multi-task and meta reinforcement learning. Tianhe Yu et al. Conference on robot learning 2020. [[paper](https://arxiv.org/abs/1910.10897)][[projectpage](https://meta-world.github.io/)]
[[code](https://github.com/Farama-Foundation/Metaworld)]
24. Benchmarking Vision, Language, \& Action Models in Procedurally Generated, Open Ended Action Environments. Pranav Guruprasad et al. arXiv 2025. [[paper](https://arxiv.org/abs/2505.05540v2?ref=manifoldrg.com)]
[[code](https://github.com/Physical-Intelligence/openpi)]
25. Teamcraft: A benchmark for multi-modal multi-agent systems in minecraft. Qian Long et al. arXiv 2024. [[paper](https://arxiv.org/abs/2412.05255)]
[[GitHub](https://github.com/teamcraft-bench/teamcraft)]
26. An Open-Source Software Toolkit \& Benchmark Suite for the Evaluation and Adaptation of Multimodal Action Models. Pranav Guruprasad et al. Venue 202X. [[paper](https://arxiv.org/abs/2506.09172?ref=manifoldrg.com)]
27. Exploring the limits of vision-language-action manipulations in cross-task generalization. Jiaming Zhou et al. arXiv 2025. [[paper](https://arxiv.org/abs/2505.15660)][[projectpage](https://jiaming-zhou.github.io/AGNOSTOS/)]
[[code](https://github.com/jiaming-zhou/X-ICM)]
28. What can rl bring to vla generalization? an empirical study. Jijia Liu et al. NeurIPS 2025. [[paper](https://arxiv.org/abs/2505.19789)][[projectpage](https://rlvla.github.io/)]
[[code](https://github.com/gen-robot/RL4VLA)]
[[models](https://huggingface.co/collections/gen-robot/rlvla)]
29. Learning to Plan with Personalized Preferences. Manjie Xu et al. arXiv 2025. [[paper](https://arxiv.org/abs/2502.00858)][[projectpage](https://sites.google.com/view/personalized-planning)]
