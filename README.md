...
16. Why do mllms struggle with spatial understanding? a systematic analysis from data to architecture. Wanyue Zhang et al. arXiv 2025. [[paper](LINK)]
17. Pca-bench: Evaluating multimodal large language models in perception-cognition-action chain. Liang Chen et al. arXiv 2024. [[paper](LINK)]
18. Lvbench: An extreme long video understanding benchmark. Weihan Wang et al. ICCV 2025. [[paper](LINK)]
19. Embodiedbench: Comprehensive benchmarking multi-modal large language models for vision-driven embodied agents. Rui Yang et al. arXiv 2025. [[paper](LINK)]
